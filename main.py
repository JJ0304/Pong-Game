...
pygame.display.set_caption('Janajans Pong Game')
...
def draw(canvas):
    ...
    # noinspection PyTypeChcker
    label1 = myfont1.render("White Score " + str(l_score), 1, (255, 255, 0))
    canvas.blit(label1, (50, 20))

    myfont2 = pygame.font.SysFont("Comic Sans MS", 20)
    # noinspection PyTypeChcker
    label2 = myfont2.render("Green Score " + str(r_score), 1, (255, 255, 0))
...
def keyup(events):
    ...
    if events.key in (K_w, K_s):
        paddle1_vel = 0
    elif events.key in (K_UP, K_DOWN):
        paddle2_vel = 0
